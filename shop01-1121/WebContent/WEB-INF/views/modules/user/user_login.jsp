  ...
  <a href="javascript:;" class="btn btn-blue f-r3" id="btn_login">立即登录</a> </div>
     ...
     <a href="${ctx }/pass/aa/login" class="btn btn-blue f-r3" id="btn_login">立即登录</a> </div>
          ...
          <div class="item col-xs-12" style="height:auto">
            <label class="valid  line" ><a href="${ctx }/pass/forgetPassword">商家登录</a></label>
          </div>
        </div>
      </div>
    </div>
...
<footer class="footer clear">
  <div class="footer_copyright"> © 2019<a href="https://git.oschina.net/Morning_/Morning" target="_blank"> 穿鞋子的猫 </a> </div>
</footer>
