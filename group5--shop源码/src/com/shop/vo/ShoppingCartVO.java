...
public class ShoppingCartVO implements Serializable {
	...
	public String toString() {
		return "ShoppingCartVO{" + "cartId=" + cartId + ", productSpecNumber=" + productSpecNumber + ", userId="
				+ userId + ", buyNumber=" + buyNumber + ", productNumber=" + productNumber + ", name='" + name + '\''
				+ ", picImg='" + picImg + '\'' + ", stock=" + stock + ", salesVolume=" + salesVolume + ", price="
				+ price + ", productAmount=" + productAmount + ", spec='" + spec + '\'' + ", specificationName="
				+ specificationName + ", sellerId=" + sellerId + '}';
	}
}