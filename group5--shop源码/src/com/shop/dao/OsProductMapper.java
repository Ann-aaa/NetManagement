...
public interface OsProductMapper {
	...
	Long selectSellerIdByProductId(Long productId);
	
	
	
	List<OsProduct> selectAll();
    List<OsProduct> selectAllProducts();
    List<OsProduct> selectBySellerId(Long sellerId);
    Long selectProductIdByName(String name);
    Long selectProductIdByNameAndSellerId(String name,Long sellerId);
