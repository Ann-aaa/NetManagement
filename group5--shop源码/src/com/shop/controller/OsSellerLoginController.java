...
public class OsSellerLoginController {
	...
	public String login(@ModelAttribute("seller") Seller seller, @RequestParam("registerCode") String registerCode,
			@RequestParam("money") String money, HttpSession session, HttpServletRequest request) {
