  ...
  <div class="main">
    <div class="reg-box-pan display-inline">
      ...
      <div class="reg-box" id="verifyCheck" style="margin-top:20px;">
        <div class="part1">
          <form id="verifyUser" name="proinsert1" action="${ctx}/cart/update/stock/${sessionScope.osProductSpecification.productSpecNumber}" method="post">
            
           
          <div class="item col-xs-12"> <span class="intelligent-label f-fl"><b class="ftx04">*</b>商品库存：</span>
              <div class="f-fl item-ifo">
               <input type="text" name="prosort" value="${sessionScope.osProductSpecification.stock}" maxlength="50" class="txt03 f-r3 required btn_part1"   id="prosort2" />
               </label>              
              </div>
            </div>
