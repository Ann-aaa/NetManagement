            ...
            <dl class="goods-info-box ">
              <dt class="goods-info-head">
                <dl id="J_goodsInfoBlock">
                  ...
                  <a href="javascript:void(0)" onclick="add_cart(this)" id="goodsDetailAddCartBtn" class="btn btn-primary goods-add-cart-btn" data-product-spec-number="">
                   <i class="glyphicon glyphicon-shopping-cart"></i>添加商品属性 </a> 
                  <a id="goodsDetailUpdateSortBtn" class=" btn btn-gray  goods-collect-btn" data-product-spec-number=""  href="javascript:void(0)" onclick="update_sort(this)">
                   <i class="glyphicon glyphicon-heart-empty"></i>更新库存 </a> </dd>
  ...
  <div class="goods-sub-bar  goods-sub-bar-play" id="goodsSubBar" style="top: 0px;display: none;">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="span4">
          <div class="fr" id="goodsSubBarBtnBox"> <a href="" class="btn btn-primary goods-add-cart-btn" id="goodsSubBarAddCartBtn" data-disabled="false" data-product-spec-number=""> <i class="glyphicon glyphicon-shopping-cart"></i>商品详情</a> </div>
        </div>
      </div>
    </div>
  </div>
