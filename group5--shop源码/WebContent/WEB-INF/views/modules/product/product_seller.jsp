...
<body>
<!--   <li><a href="${ctx}/pro/insertpro">添加商品</a></li> -->
<!-- 轮播top菜单导航引入 -->
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="order-list-box clearfix">
        <ul class="order-list">
         <li class="${sort eq 1 ? 'active':''}"><a href="${ctx}/pro/insertpro" rel="nofollow">添加商品</a></li>
         <li class="${sort eq 1 ? 'active':''}"><a href="${ctx}/pass/ordermanage" rel="nofollow">用户订单</a></li>
        </ul>
      </div>
        ...
        <div class="goods-list clearfix">
          <c:forEach items="${products}" var="product">
            <div class="goods-item">
              <div class="figure figure-img"><a title="${product.introduce}" href="${ctx}/detail/seller/${product.productNumber}"><img src="${ctximg}/${product.picImg}" title="${product.introduce}" width="200" height="200" alt="${product.name}" /></a></div>
              <p class="desc"></p>
              <h2 class="title"><a title="${product.name}" href="${ctx}/detail/seller/${product.productNumber}">${product.name}</a></h2>
              ...
              <div class="actions clearfix">  <a class="btn-buy J_buyGoods" data-gid="${product.productNumber}" href="${ctx}/detail/seller/${product.productNumber}"><span>商品详情</span> <i class="glyphicon glyphicon-shopping-cart"></i></a> </div>
              <div class="flags">
              </div>
