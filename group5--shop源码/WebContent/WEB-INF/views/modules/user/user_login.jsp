  ...
  <div class="main">
    <div class="reg-box-pan display-inline">
      <div class="reg-box login" id="verifyCheck" style="margin-top:20px;">
        <div class="part1">
          <form name="login" action="${ctx}/pass/aa/login" method="post">
            <div class="item col-xs-12">
              <div class="f-fl item-ifo">
                <input type="text" name="loginName" maxlength="20" placeholder="手机号码" class="txt03 f-r3 required loginPage" tabindex="1" data-valid="isNonEmpty" data-error="请输入帐号" id="adminNo" />
  ...
  <a href="javascript:;" class="btn btn-blue f-r3" id="btn_login">立即登录</a> </div>
   ...
   <!--    <a href="${ctx }/pass/aa/login" class="btn btn-blue f-r3" id="btn_login">立即登录</a> </div>
          ...
          <div class="item col-xs-12" style="height:auto">
            <label class="valid  line" ><a href="${ctx }/pass1/login">商家登录</a></label>
          </div>
        </div>
      </div>
    </div>
