      ...
      <div class="section section-order">
        <div class="order-info clearfix">
          <div class="fl">
            ...
            <p class="order-time">请在<span class="pay-time-tip">29分钟</span>内完成支付, 超时后将取消订单</p>
            <p class="post-info" id="J_postInfo"> 收货信息：${orderShipment.userName} ${orderShipment.userPhone}&nbsp;&nbsp;
              &nbsp;&nbsp;${orderShipment.userAdress} </p>
          </div>
          <div class="fr">
        ...
        <div class="payment-box ">
          ...
          <div class="payment-body">
            <ul class="clearfix payment-list J_paymentList J_linksign-customize">
              <li id="J_weixin"><a href="${ctx}/success"><img src="//c1.mifile.cn/f/i/15/pay/wechat0715.jpg" alt="微信支付" style="margin-left: 0;"/></a></li>
              <li class="J_bank">
                <input type="radio" name="payOnlineBank" id="alipay" value="alipay" />
              <a href="${ctx}/success"><img src="//c1.mifile.cn/f/i/15/pay/alipay-0718-1.png" alt="支付宝" style="margin-left: 0;"/></a></li>
              <li class="J_bank">
                <input type="radio" name="payOnlineBank" id="unionpay" value="unionpay" />
               <a href="${ctx}/success"> <img src="//s01.mifile.cn/i/banklogo/unionpay.png?ver2015" alt="银联" style="margin-left: 0;"/></a></li>
              <li class="J_bank">
                <input type="radio" name="payOnlineBank" id="cft" value="cft" />
                <a href="${ctx}/success"><img src="//s01.mifile.cn/i/banklogo/cft.png" alt="财付通" style="margin-left: 0;"/></a></li>
            </ul>
