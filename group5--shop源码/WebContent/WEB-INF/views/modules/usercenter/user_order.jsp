        ...
        <div id="J_orderList">
          <ul class="order-list">
            <c:forEach items="${orderVOs}" var="orderVO">
                      ...
                      <thead>
                        <tr>
                          <th class="col-main"> <p class="caption-info">
                              ...
                              <span class="sep">|</span><span class="sep">|</span>订单号： <a href="${ctx}/uc/order/${orderVO.orderNumber}">${orderVO.orderNumber}</a><span class="sep">|</span>在线支付</p>
                          </th>
                        ...
                        <tr>
                          <td class="order-items"><ul class="goods-list">
                              <c:forEach items="${orderVO.orderProducts}" var="orderProduct">
                                <li>
                                  <div class="figure figure-thumb"> <a href="${ctx}/detail/${orderProduct.productNumber}" target="_blank">
                                    <img src="${ctximg}/${orderProduct.picImg}" width="80" height="80" alt="${orderProduct.name}&nbsp;&nbsp;" title="${orderProduct.name}&nbsp;&nbsp;${orderProduct.productSpecName}"> </a> </div>
                                  <p class="name"> <a target="_blank" href="${ctx}/detail/${orderProduct.productNumber}">
                                      ${orderProduct.name}&nbsp;&nbsp;${orderProduct.productSpecName}</a> </p>
                    ...
                    <table class="order-detail-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="order-actions"><a class="btn btn-small btn-line-gray" href="${ctx}/uc/order/${orderVO.orderNumber}">订单详情</a>
                          <a class="btn btn-small btn-line-gray" href="${ctx}/uc/order/status/${orderVO.orderNumber}">确认收货</a></td>
              ...
              <c:if test="${orderVO.orderStatus eq 4 || orderVO.orderStatus eq 5}">
                <li class="uc-order-item uc-order-item-shipping">
                  <div class="order-detail">
                    <div class="order-summary">
                      <div class="order-status">配送中</div>
                      <p class="order-desc J_deliverDesc">请注意物流，及时收货</p>
                    </div>
                    <table class="order-detail-table">
                      <thead>
                        <tr>
