...
//
//            // 通过类目ID、排序、分页查找商品列表
//          /*  List<OsProduct> products1 = osProductService.getAll();
//            List<OsProduct> products = new ArrayList<OsProduct>(); 	
//            		for(OsProduct product:products1){
//            			Seller seller=(Seller) request.getSession().getAttribute("seller");
//            			Long psellerId =  product.getSellerId();
//            			Long ssellerId = seller.getSellerId();
//            			if(Long.valueOf(psellerId)==Long.valueOf(ssellerId)){
