      ...
      <div class="box-bd">
        <div class="portal-main clearfix">
          <div class="user-card">
            ...
            <p class="tip">你好</p>
            <a class="link" href="" target="_blank">修改个人信息 &gt;</a> <img class="avatar" src="${ctximg}/${sessionScope.user.picImg}" width="160" height="160" alt="${sessionScope.user.userName}"> </div>
        ...
        <div class="portal-sub">
          <ul class="info-list clearfix">
            <li>
              ...
              <a href="#">查看待支付订单&nbsp;<i class="glyphicon glyphicon-chevron-right"></i></a> <img src="${ctxsta}/os/images/portal-icon-1.png" alt=""> </li>
            <li>
              <h3>待收货的订单：<span class="num">0</span></h3>
              <a href="#">查看待收货订单&nbsp;<i class="glyphicon glyphicon-chevron-right"></i></a> <img src="${ctxsta}/os/images/portal-icon-2.png" alt=""> </li>
          </ul>
        </div>
      </div>
    </div>
