  ...
  <div class="container-fluid">
    <div class="catbox hide" id="J_cartBox">
        ...
        <tbody>
          <c:forEach items="${sessionScope.cart.shoppingCartVOs}" var="shoppingCart">
            <tr data-sid="${shoppingCart.productSpecNumber}">
              <td class="checkbox"><input data-initial="true" data-sid="${shoppingCart.productSpecNumber}" data-check-status="1" class="check-one check" type="checkbox"/></td>
      ...
      <div class="cart-bar clearfix" id="J_cartBar">
        ...
        <span class="total-price"> 合计（不含运费）：<em id="J_cartTotalPrice"></em>元 </span> <a href="javascript:void(0);" class="btn btn-a btn btn-primary" id="J_goCheckout" onclick="#">去结算</a>
