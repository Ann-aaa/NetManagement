  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <c:if test="${not empty seller.sellerId}">
        <div class="topbar-info" id="J_userInfo1">
        <span class="user">
        <a rel="nofollow" class="user-name" href="${ctx}/seller/list" target="_blank">${seller.sellerName}</a>
        </span>
          
          <span class="user">
          <a rel="nofollow" class="user-name" href="${ctx}/pass1/logout">退出登录</a>
          </span>
