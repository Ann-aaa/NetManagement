...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='收获地址表';
...
INSERT INTO `os_address` VALUES ('45', '42', '苗田', '家', '17853243093', '刷hi代数方法反馈', '250200', null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=utf8 COMMENT='订单表';

-- ----------------------------
-- Records of os_order
-- ----------------------------
INSERT INTO `os_order` VALUES ('1', '14907102171468493', '1', '1', '1', '1', '0', '1', null, '2', null, null, '24985', '25000', '24985', '15');
...
INSERT INTO `os_order` VALUES ('10', '14944390772967434', '1', '1', '1', '1', '0', '1', null, '3', null, null, '9843', '9848', '9843', '7');
INSERT INTO `os_order` VALUES ('11', '14944392556221620', '1', '1', '1', '1', '0', '1', null, '12', null, null, '1599', '1600', '1599', '1');
INSERT INTO `os_order` VALUES ('12', '14944739317304562', '1', '1', '3', '1', '0', '2', '陈星星', '2', null, null, '1828', '1829', '1828', '2');
...
INSERT INTO `os_order` VALUES ('133', '15766305667598505', '37', '1', '1', '1', '0', '1', '', '3', '2019-12-18 08:56:06', null, '169', '0', '169', '1');
INSERT INTO `os_order` VALUES ('134', '15766311589735680', '37', '1', '1', '1', '0', '1', '', '2', '2019-12-18 09:05:58', null, '149', '0', '149', '1');
INSERT INTO `os_order` VALUES ('135', '15766314553844971', '34', '1', '1', '1', '0', '2', '青岛大学', '3', '2019-12-18 09:10:52', null, '4376', '0', '4376', '2');
INSERT INTO `os_order` VALUES ('136', '15766584491103035', '35', '1', '1', '1', '0', '1', '', '2', '2019-12-18 16:40:49', null, '1599', '0', '1599', '1');
INSERT INTO `os_order` VALUES ('137', '15769198762109715', '37', '1', '1', '1', '0', '1', '', '4', '2019-12-21 17:17:56', null, '124', '0', '124', '1');
INSERT INTO `os_order` VALUES ('138', '15769208087077645', '28', '1', '3', '1', '0', '2', '青岛大学陈星星', '2', '2019-12-21 17:33:28', null, '4376', '0', '4376', '2');
INSERT INTO `os_order` VALUES ('139', '15769217810476925', '38', '1', '3', '1', '0', '3', '青岛大学', '3', '2019-12-21 17:49:41', null, '2018', '0', '2018', '2');
INSERT INTO `os_order` VALUES ('140', '15769223849988323', '38', '1', '1', '1', '0', '1', '', '3', '2019-12-21 17:59:44', null, '4974', '0', '4974', '1');
...
INSERT INTO `os_order` VALUES ('169', '15779344290505539', '42', '1', '1', '1', '0', '1', '', '2', '2020-01-02 11:07:09', null, '1599', '0', '1599', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COMMENT='订单明细表';
...
INSERT INTO `os_order_product` VALUES ('119', '169', '1472581220748', '小米手机5', 'images/goods/201901/1471798318820.png', '14725812207481', '白色 16G', '1599.00', null, '1', null, '1599', '0', '1');
...
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8 COMMENT='订单配送表';
...
INSERT INTO `os_order_shipment` VALUES ('83', '169', '苗田', '17853243093', '刷hi代数方法反馈', '250200', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COMMENT='订单状态表';

-- ----------------------------
-- Records of os_order_status
-- ----------------------------
INSERT INTO `os_order_status` VALUES ('1', '1', '2', null, '0', '付款成功');
...
INSERT INTO `os_order_status` VALUES ('63', '133', '3', '2019-12-18 08:56:06', '0', '商家打包发货');
INSERT INTO `os_order_status` VALUES ('64', '134', '2', '2019-12-18 09:05:59', '0', '付款成功');
INSERT INTO `os_order_status` VALUES ('65', '135', '3', '2019-12-18 09:10:55', '0', '商家打包发货');
INSERT INTO `os_order_status` VALUES ('66', '136', '2', '2019-12-18 16:40:49', '0', '付款成功');
INSERT INTO `os_order_status` VALUES ('67', '137', '4', '2019-12-21 17:17:56', '0', '等待快递揽收');
INSERT INTO `os_order_status` VALUES ('68', '138', '2', '2019-12-21 17:33:28', '0', '付款成功');
INSERT INTO `os_order_status` VALUES ('69', '139', '3', '2019-12-21 17:49:41', '0', '商家打包发货');
INSERT INTO `os_order_status` VALUES ('70', '140', '3', '2019-12-21 17:59:45', '0', '商家打包发货');
...
INSERT INTO `os_order_status` VALUES ('95', '169', '2', '2020-01-02 11:07:09', '0', '付款成功');
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COMMENT='商品表';
...
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='商品分类关联表';
...
INSERT INTO `os_product_category` VALUES ('91', '76', '34', null);
INSERT INTO `os_product_category` VALUES ('92', '78', '23', null);
...
INSERT INTO `os_product_image` VALUES ('74', '23', 'images/goods/201902/erji.jpg', '2', '1', null);
INSERT INTO `os_product_image` VALUES ('75', '21', 'images/goods/201902/erji.jpg', '2', '1', null);
INSERT INTO `os_product_image` VALUES ('77', '78', 'images/goods/201902/erji.jpg', '1', '1', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='商品参数表';
...
) ENGINE=InnoDB AUTO_INCREMENT=127 DEFAULT CHARSET=utf8 COMMENT='商品规格表';

-- ----------------------------
-- Records of os_product_specification
-- ----------------------------
INSERT INTO `os_product_specification` VALUES ('1', '14725812207481', '1', '1,3', '39', '11', '1599.00', '1600', '1', '1', null, null);
...
INSERT INTO `os_product_specification` VALUES ('20', '1475947762038', '15', null, '150', '15', '2366.00', '2366', '1', '1', null, null);
...
INSERT INTO `os_product_specification` VALUES ('26', '1478680540669', '21', null, '100', '22', '6429.00', '6429', '1', '1', null, null);
INSERT INTO `os_product_specification` VALUES ('27', '1478682438293', '22', null, '20', '24', '2416.00', '2416', '1', '1', null, null);
...
INSERT INTO `os_product_specification` VALUES ('119', '14725813003052', '3', '10,3', '99', '1', '1000.00', '1000', null, null, null, null);
...
INSERT INTO `os_product_specification` VALUES ('124', '0', '76', '12,8', '1000', null, '3800.00', '10', null, null, null, null);
INSERT INTO `os_product_specification` VALUES ('126', '9732282806664', '78', null, '2000', null, '200.00', '10', null, null, null, null);
...
INSERT INTO `os_user` VALUES ('42', '15777024300855706', '汐汐汐', 'aa123456', null, '0', '0', null, '1', '17853242108', null, null);
INSERT INTO `os_user` VALUES ('45', '15779285397264971', 'aaaaaa', 'hxk111', null, '0', '0', null, '1', '17853111111', null, null);
...
-- Records of seller
-- ----------------------------
INSERT INTO `seller` VALUES ('1', '王王王', '17853242333', 'mm123456', '6547.00');
INSERT INTO `seller` VALUES ('2', '李李李', '17853242444', 'mm123456', '18889.00');
...
INSERT INTO `seller` VALUES ('6', '新新新', '17853242003', 'mm123456', '93800.00');
...
INSERT INTO `seller` VALUES ('13', '小老鼠222', '17853241228', 'a123123', '111111.00');
INSERT INTO `seller` VALUES ('14', '王王王', '17853241225', 'mm123456', '1000.00');
